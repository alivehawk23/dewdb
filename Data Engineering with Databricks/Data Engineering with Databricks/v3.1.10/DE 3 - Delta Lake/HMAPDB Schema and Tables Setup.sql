...
CREATE SCHEMA IF NOT EXISTS ${da.schema_name}_hmapbdb_dlk_mes;
...
DESCRIBE SCHEMA EXTENDED ${da.schema_name}_hmapbdb_dlk_mes;
...
USE ${da.schema_name}_hmapbdb_dlk_mes; 
-- HMAPDB.DLK_MES.T_BMS_MEMBER definition

create or replace TABLE T_BMS_MEMBER (
	RECORD_TYPE VARCHAR(255),
	MBR_SID VARCHAR(255),
	DATA_SOURCE_LKPCD VARCHAR(255),
	CREATED_DATE VARCHAR(255),
	MODIFIED_DATE VARCHAR(255),
	LAST_INTERFACE_RUN_DATE VARCHAR(255),
	LAST_INTERFACE_TRNSCTN_NMBR VARCHAR(255),
	FILE_NM VARCHAR(100),
...
DESCRIBE EXTENDED T_BMS_MEMBER;

-- COMMAND ----------

USE ${da.schema_name}_hmapbdb_dlk_mes; 
-- HMAPDB.DLK_MES.T_BMS_MBR_MEDICARE_IDNTFR definition

CREATE OR REPLACE TABLE T_BMS_MBR_MEDICARE_IDNTFR (
    RECORD_TYPE VARCHAR(255),
    MBR_MEDICARE_IDNTFR_SID VARCHAR(255) NOT NULL,
    MBR_SID VARCHAR(255),
    MEDICARE_BNFCRY_IDNTFR VARCHAR(255),
    SGMNT_OCRNC_NMBR VARCHAR(255),
    FROM_DATE VARCHAR(255),
    TO_DATE VARCHAR(255),
    REMARK VARCHAR(1000),
    DATA_SOURCE_LKPCD VARCHAR(255),
    OPRTNL_FLAG VARCHAR(255),
    CREATED_DATE VARCHAR(255),
    MODIFIED_DATE VARCHAR(255),
    FILE_NM VARCHAR(100),
    RECORD_CREATED_BY VARCHAR(50),
