...
course_config = CourseConfig(course_code = "dewd",
                            ...
                            #expected_dbrs = "12.2.x-scala2.12, 12.2.x-photon-scala2.12, 12.2.x-cpu-ml-scala2.12")
                             supported_dbrs = ["10.4.x-scala2.12", "10.4.x-photon-scala2.12", "10.4.x-cpu-ml-scala2.12"],
                             expected_dbrs = "10.4.x-scala2.12, 10.4.x-photon-scala2.12, 10.4.x-cpu-ml-scala2.12")
